...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden bg-transparent h-full relative flex items-center justify-center">
      ...
      <div className=" h-24 md:h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-purple-500 to-transparent animate-move">
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-md w-full h-32 mx-auto p-1 -mt-5 rounded-xl  bg-transparent group",
        className
      )}
    >
      {children}
  ...
  return (
    <div
      className={cn(
        ...
        className,
        showGradient &&
          "bg-purple-500/20  [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
      )}
    >
      {children}
    </div>
