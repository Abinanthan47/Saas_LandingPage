...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        "grid max-w-5xl mx-auto mb-8 justify-center auto-rows-[22rem] grid-cols-3 gap-4",
        className
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "bg-transaparent [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      className
    )}
    {...props}
  >
